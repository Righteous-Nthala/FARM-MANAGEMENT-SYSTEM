      ...
      body: Center(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              buildNavigationButton(context, 'Crops', CropPage()),
              const SizedBox(height: 15),
              buildNavigationButton(context, 'Pesticides', PesticidesPage()),
              const SizedBox(height: 15),
              buildNavigationButton(context, 'Fertilizer', FertilizerPage()),
              const SizedBox(height: 15),
              buildNavigationButton(context, 'Irrigation', rrigationPage()),
              const SizedBox(height: 15),
              buildNavigationButton(context, 'Sales', SalesPage()),
            ],
          ),
        ),
      ),
